...
| Embedding model | Generates embeddings for semantic search. Embeddings can be generated by your application or automatically by `mongot`, depending on the index configuration. |
