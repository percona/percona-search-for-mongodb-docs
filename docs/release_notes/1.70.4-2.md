...
For setup instructions and supported configurations, see our comprehensive [documentation](https://percona-search-for-mongodb/automatic-embedding-with-OpenAI-providers.html).
